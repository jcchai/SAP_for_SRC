...
# 1. Alignment to genome with STAR aligner v2.4.0.1.
# 1a) Alignment generate genome. 
STAR --runMode genomeGenerate \
--genomeDir /path/to/STAR_mm10/ \
--genomeFastaFiles ~/mm10_index/Mus_musculus/UCSC/mm10/Sequence/WholeGenomeFasta/genome.fa \
--runThreadN 16

# 1b) Alignment to genome (or transcriptome).  The newer version (2.4.0). 
